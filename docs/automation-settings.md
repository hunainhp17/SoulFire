...
- a filtered claim explorer with claim search, owner and type filters, owner-focus workflow, release-by-claim, release-by-owner, and direct inspect-owner-memory handoff
